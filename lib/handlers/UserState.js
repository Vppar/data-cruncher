...
var SubscriptionsHandler = require('./SubscriptionsHandler.js');
var ConsultantHandler = require('./ConsultantHandler');
var BIService = require('./BIService.js');

var ConsultantInterface = require('../interfaces/ConsultantInterface.js');
...
function UserState(userRef){
    ...
    _.extend(handlers, orderHandler.handlers, targetHandler.handlers, subscriptionsHandler.handlers, consultantHandler.handlers);

    subscriptionsHandler.on('add', function(event){
