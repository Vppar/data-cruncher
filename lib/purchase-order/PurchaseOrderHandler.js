...
function PurchaseOrderHandler() {
  ...
  this.STATUS_STASHED = ArrayUtils.find(status, 'name', 'stashed').id;
  this.STATUS_CANCELED = ArrayUtils.find(status, 'name', 'canceled').id;
  this.STATUS_CONFIRMED = ArrayUtils.find(status, 'name', 'confirmed').id;
  this.STATUS_PARC_REC = ArrayUtils.find(status, 'name', 'partiallyReceived').id;
  this.STATUS_RECEIVED = ArrayUtils.find(status, 'name', 'received').id;
